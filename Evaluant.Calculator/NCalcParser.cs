                ...
                switch (alt20)
                {
                    case 1:
                        ...
                        // C:\\Users\\sebros\\My Projects\\NCalc\\Grammar\\NCalc.g:208:5: INTEGER
                        {
                            ...
                            {
                                var integerText = (INTEGER35 != null ? INTEGER35.Text : null);
                                if (long.TryParse(integerText, out var integerValue))
                                {
                                    retval.value = (integerValue >= int.MinValue && integerValue <= int.MaxValue)
                                        ? new ValueExpression((int)integerValue)
                                        : new ValueExpression(integerValue);
                                }
                                else
                                {
                                    throw new RecognitionException("Invalid integer literal: " + integerText);
                                }
                            }
